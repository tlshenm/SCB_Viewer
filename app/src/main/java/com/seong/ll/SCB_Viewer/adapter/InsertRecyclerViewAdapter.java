...
import com.seong.ll.SCB_Viewer.data.ZipInfoData;
...
public class InsertRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public InsertRecyclerViewAdapter(Context context, List<DummyItem> items) {
        mContext = context;
        mValues = items;
    }
